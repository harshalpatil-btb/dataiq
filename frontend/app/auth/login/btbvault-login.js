    ...
    <div className="min-h-screen flex items-stretch">
      ...
      <div className="hidden lg:flex flex-col justify-between w-[420px] shrink-0 bg-[#0f0f18] p-12">
        <div className="flex items-center gap-2.5">
          <div className="w-8 h-8 rounded-lg bg-[#3d5afe] flex items-center justify-center text-white font-black text-sm">B</div>
          <div>
            <div className="text-white font-extrabold text-lg tracking-tight leading-none">btbVault</div>
            <div className="text-[rgba(255,255,255,0.35)] text-[10px] tracking-widest uppercase">Embrace Expansion</div>
          </div>
        </div>
        <div>
          {[
            ['🏠', 'Deal Rooms', 'One workspace per deal — branded for your buyers'],
            ['⚡', 'Live Alerts', 'Know the moment pricing is viewed or forwarded'],
            ['🤖', 'AI Follow-ups', 'GPT-4o drafts context-aware emails in 1 click'],
            ['✅', 'Action Plans', 'Shared MAP keeps both sides accountable'],
          ].map(([icon, title, desc]) => (
        ...
        <div className="bg-[rgba(255,255,255,0.04)] rounded-xl p-5 border border-[rgba(255,255,255,0.08)]">
          ...
          <p className="text-[rgba(255,255,255,0.7)] text-sm italic leading-relaxed">"I got an alert the moment the CFO opened pricing. Called within 10 minutes. Closed that week."</p>
      ...
      <div className="flex-1 flex items-center justify-center px-6 py-12">
        <div className="w-full max-w-sm">
          <div className="flex items-center gap-2 mb-8 lg:hidden">
            <div className="w-8 h-8 rounded-lg bg-[#3d5afe] flex items-center justify-center text-white font-black text-sm">B</div>
            <div>
              <div className="font-extrabold text-lg leading-none">btbVault</div>
              <div className="text-[#8a8899] text-[10px] tracking-widest uppercase">Embrace Expansion</div>
            </div>
          </div>

          <h1 className="text-2xl font-extrabold tracking-tight mb-1">Welcome back</h1>
          <p className="text-[#8a8899] text-sm mb-8">Sign in to your btbVault workspace</p>
